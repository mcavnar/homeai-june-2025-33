...
const cleanExtractedText = (rawText: string): string => {
  ...
  // REMOVED: Duplicate paragraph removal - this was too aggressive for inspection reports
  // Home inspection reports naturally have repeated phrases and similar findings across rooms
