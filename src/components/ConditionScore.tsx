            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="p-3 bg-red-50 rounded-lg cursor-help">
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    Based on repair costs relative to property size, value, and national averages. 
                    Higher repair costs result in larger penalties.
                  </p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="p-3 bg-orange-50 rounded-lg cursor-help">
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    Based on the total number of issues found compared to typical home inspections. 
                    More than 20 issues triggers increasing penalties.
                  </p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="p-3 bg-purple-50 rounded-lg cursor-help">
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    Based on how the property performed in the market - longer days on market, 
                    lower sale-to-list ratio, or smaller size compared to neighborhood averages.
                  </p>
                </TooltipContent>
              </Tooltip>
            </div>
