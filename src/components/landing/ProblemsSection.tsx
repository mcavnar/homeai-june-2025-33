        ...
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="bg-white rounded-2xl p-12 shadow-sm border border-gray-100">
            <blockquote className="text-gray-700 text-lg font-light leading-relaxed mb-8">
              "We started HomeAI because some of us recently bought homes and found the home inspection report to be the most stressful part. In my case, the report was over 70 pages and full of issues. It was detailed, but I had to spend a lot of time figuring out costs and how to negotiate. I kept flipping through the PDF and taking notes.<br/><br/>When I began working with AI, I saw it could make inspection reports much easier to use and more valuable. By tapping into databases with millions of contractor quotes and cost data, we could give accurate repair estimates and helpful negotiation tips. We also explain the home's key systems and maintenance needs.<br/><br/>This is just the start of our journey. HomeAI is free—give it a try and let us know what you think!"
            </blockquote>
