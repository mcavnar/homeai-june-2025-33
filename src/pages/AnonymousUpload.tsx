              ...
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="border-t pt-6 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">Your analysis may take a minute or more to render. We understand this can seem prolonged but it's how we make sure your information is as accurate as possible.</span>
                  </div>
